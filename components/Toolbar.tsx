...
const Toolbar: React.FC<ToolbarProps> = ({ 
  ...
  return (
    <div data-toolbar className="absolute z-20 left-1/2 -translate-x-1/2 w-full max-w-[95vw] md:w-auto bottom-[max(1rem,env(safe-area-inset-bottom))] md:top-4 md:bottom-auto transition-all duration-300">
